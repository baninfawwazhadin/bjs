...
export class User {
  ...
  @Column('int', { name: 'password_attempt_counter', nullable: true })
  password_attempt_counter: number | null;

  @Column('datetime', { name: 'password_expired_date', nullable: true })
  ...
  @Column('varchar', { name: 'last_log_message', nullable: true, length: 500 })
  last_log_message: string | null;

  @Column('enum', { name: 'status', nullable: true, enum: ['LOGIN', 'LOGOUT'] })
